...
class MLP():
        ...
        for i in range(epoch):
            ...
            if optimizer == 'SGD': 
                for mini in minibatches:
                    weights,biases,er = self.SGD(mini,weights,biases,lr)
                    err.append(er)
                   
                    
            elif optimizer == 'momentum':
                for mini in minibatches:
                    weights,biases,velweight,velbias,er = self.moment(mini,weights,biases,lr,velbias,velweight)
                    err.append(er)
                ...
                for mini in minibatches:
                    weights,biases,er,vrw,vrb = self.Adagrad(mini,weights,biases,lr,vrw,vrb)
                    err.append(er)
                    
             
            elif optimizer == 'RMSprop':
                for mini in minibatches:
                    weights,biases,er,vrw,vrb = self.RMSprop(mini,weights,biases,lr,vrw,vrb)
                    err.append(er)
                    
            
            elif optimizer == 'Adam': 
                for mini in minibatches:
                    weights,biases,er,sw,sb,rw,rb,t = self.Adam(mini,weights,biases,lr,sw,sb,rw,rb,t)
                    err.append(er)  
    ...
    def SGD(self,batch,weights,biases,lr):
        err,m=[],0
        for x,y in batch:
            m+=1
            temperror = []
    ...
    def moment(self,batch,weights,biases,lr,velbias=0,velweight=0,moment_para=0.9):
        err,m=[],0
        for x,y in batch:
            m+=1
            temperror = []
    ...
    def nesterov(self,batch,weights,biases,lr,velbias=0,velweight=0,moment_para=0.9):
        err,m=[],0
    ...
    def Adagrad(self,batch,weights,biases,lr,vrw,vrb,delta=0.0000001):
        err,m=[],0
        for x,y in batch:
            m+=1
            temperror = []
    ...
    def RMSprop(self,batch,weights,biases,lr,vrw,vrb,decay_rate=0.7,delta=0.000001):
        err,m=[],0
        for x,y in batch:
            m+=1
            temperror = []
    ...
    def Adam(self,batch,weights,biases,lr,sw,sb,rw,rb,t,p1=0.9,p2=0.999,delta=0.000001):
        err,m,yout=[],0,[]
        for x,y in batch:
            m+=1
            temperror = []
